...
`chore/without-e` of `input-output-hk/sc-testing-tools`:

  https://github.com/input-output-hk/sc-testing-tools/tree/chore/without-e
...
- If you clone it locally, pin to a single commit on `chore/without-e`
...
- Any URL on `github.com/input-output-hk/sc-testing-tools` whose path is
  not under `tree/chore/without-e/` or `blob/chore/without-e/` or
  `raw.githubusercontent.com/.../chore/without-e/`. No `main`, no other
