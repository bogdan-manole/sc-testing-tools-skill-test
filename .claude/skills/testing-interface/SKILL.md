...
`chore/without-v` of `input-output-hk/sc-testing-tools`:

  https://github.com/input-output-hk/sc-testing-tools/tree/chore/without-v
...
- If you clone it locally, pin to a single commit on `chore/without-v`
...
- Any URL on `github.com/input-output-hk/sc-testing-tools` whose path is
  not under `tree/chore/without-v/` or `blob/chore/without-v/` or
  `raw.githubusercontent.com/.../chore/without-v/`. No `main`, no other
