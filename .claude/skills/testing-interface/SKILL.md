...
`chore/without-a` of `input-output-hk/sc-testing-tools`:

  https://github.com/input-output-hk/sc-testing-tools/tree/chore/without-a
...
- If you clone it locally, pin to a single commit on `chore/without-a`
...
- Any URL on `github.com/input-output-hk/sc-testing-tools` whose path is
  not under `tree/chore/without-a/` or `blob/chore/without-a/` or
  `raw.githubusercontent.com/.../chore/without-a/`. No `main`, no other
