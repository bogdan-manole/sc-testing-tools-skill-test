...
treatment). All facts here come from `chore/without-v` of
`sc-testing-tools`. The authoritative module is
[`Convex.ThreatModel.All`](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/src/testing-interface/lib/Convex/ThreatModel/All.hs);
the per-attack modules under
[`Convex.ThreatModel.*`](https://github.com/input-output-hk/sc-testing-tools/tree/chore/without-v/src/testing-interface/lib/Convex/ThreatModel)
...
[`allThreatModels`](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/src/testing-interface/lib/Convex/ThreatModel/All.hs)
...
- Per-attack modules live under `Convex.ThreatModel.<Name>` on
  [chore/without-v](https://github.com/input-output-hk/sc-testing-tools/tree/chore/without-v/src/testing-interface/lib/Convex/ThreatModel).
...
[`AikenVestingSpec.hs`](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/src/testing-interface/test/AikenVestingSpec.hs),
[`AikenSellNftSpec.hs`](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/src/testing-interface/test/AikenSellNftSpec.hs),
[`AikenMultisigTreasurySpec.hs`](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/src/testing-interface/test/AikenMultisigTreasurySpec.hs)
(and `V2` / `V3` variants),
[`AikenKingOfCardanoSpec.hs`](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/src/testing-interface/test/AikenKingOfCardanoSpec.hs),
[`AikenTipJarSpec.hs`](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/src/testing-interface/test/AikenTipJarSpec.hs).
...
[chore/without-v README](https://github.com/input-output-hk/sc-testing-tools/blob/chore/without-v/README.md).
